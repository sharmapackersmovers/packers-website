  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-20 hero-gradient overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Truck className="w-3.5 h-3.5 text-electric-400" />
        ...
        >
          From packing a single room to relocating an entire corporation — we
          have specialized services for every moving need.
        </motion.p>
      </div>
